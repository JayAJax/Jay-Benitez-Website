...
const CaseStudies = ({ isDarkMode }) => {
  const items = [
    {
      ...
      image: '/lupa.jpg', // FIXED: Pointing to public folder
    },
    {
      id: 2,
      type: 'testimonial',
      ...
      image: '/Dave.png', // FIXED: Pointing to public folder & matched Capital D
    },
    {
      id: 'tags-1',
      type: 'tags',
    ...
    },
    {
      ...
      image: '/shaibel.jpg', // FIXED: Pointing to public folder
    },
    {
      id: 4,
      type: 'testimonial',
      ...
      image: '/beach.jpg', // FIXED: Pointing to public folder
    },
    {
      id: 'tags-2',
      type: 'tags',
  ...
  return (
    <div className="flex flex-row items-center space-x-8 p-6"> 
      {items.map((item) => {
        // 1. RENDER TAGS
        if (item.type === 'tags') {
          return (
            ...
            <div className={`flex items-center mb-3 ${item.type === 'case-study' ? 'flex-col items-start' : 'flex-row'}`}>
              <img
                ...
                onError={(e) => { 
                  ...
                  // This fallback is only if the image is truly missing from your public folder
